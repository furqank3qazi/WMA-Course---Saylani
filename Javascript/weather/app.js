...
let getweather = ()=>{
    let c_name = document.querySelector("#inp-weather").value
        ...
        .then((res)=>{
        result.innerHTML = `<p style="font-size: 28px;font-weight: bolder; color: rgb(221, 221, 235);padding: 5px;font-style: oblique;text-decoration: underline rgb(221, 221, 235); margin-top: -1px">Weather for ${c_name} City</p><div id="result-img"><img src="images/temp.gif"><p> Temperature: ${res.data.main.temp} °C </p></div>`
