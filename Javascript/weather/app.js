...
let getweather = ()=>{
    let c_name = document.querySelector("#inp-weather").value
        ...
        .then((res)=>{
        result.innerHTML = `<p style="font-size: 22px;font-weight: bolder; color: rgb(33, 33, 66);border-radius: 50px;padding: 5px;font-style: oblique;border: 3px solid rgb(221, 221, 235);margin-top: -1px">Weather for ${c_name} City</p><div id="result-img"><img src="images/temp.gif"><p> Temperature: ${res.data.main.temp} °C </p></div>`
